      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-2">
          <div className="flex-1">
            <div className="text-xs text-gray-500 mb-1">現在のレベル</div>
            <div className={`inline-flex items-center px-3 py-1 rounded-full text-white text-xs font-semibold ${currentInfo.color} shadow-sm`}>
              {currentInfo.label}
            </div>
          </div>
          ...
          <div className="flex-1 text-right">
            ...
            <div className={`inline-flex items-center px-3 py-1 rounded-full text-white text-xs font-semibold ${goalInfo.color} shadow-sm`}>
              {goalInfo.label}
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between pt-2 border-t border-gray-200/50">
          <div>
            ...
            <div className="text-lg font-bold text-cyan-600">{profile.totalSessions}回</div>
          </div>
